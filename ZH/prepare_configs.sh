...
#    curl -s --insecure https://cms-pdmv.cern.ch/mcm/public/restapi/requests/get_fragment/HIG-RunIISummer15wmLHEGS-00328\
#               --retry 2 --create-dirs -o Configuration/GenProduction/python/HIG-RunIISummer15wmLHEGS-00328-fragment.py 
#    [ -s Configuration/GenProduction/python/HIG-RunIISummer15wmLHEGS-00328-fragment.py ] || exit $?;
    cp "$ScriptDir"/LHE_step_fragment.py  Configuration/GenProduction/python/
...
setup_cmssw slc6_amd64_gcc630 CMSSW_9_4_4
